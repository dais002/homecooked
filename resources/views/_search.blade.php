<div class="bg-searchcontainer font-oxygen flex justify-center p-3">
  <div class="flex items-center justify-between bg-white rounded-full w-3/4 md:w-1/2 lg:w-2/5 max-w-m h-10">
    <input class="h-8 tracking-wider rounded-full w-full px-6 py-2 text-gray-700 focus:outline-none" id="search" type="text" placeholder="Search">
    <div class="pr-2 py-1 h-10">
      <form action="">
        <button class="bg-btn-green text-white p-2 rounded-full hover:bg-blue-700 focus:outline-none w-8 h-8 flex items-center justify-center">
